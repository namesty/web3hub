          ...
          <Flex className="top">
            ...
            >
              <Flex sx={{ justifyContent: 'space-between', mb: '10px' }}>
                <div className="left">
                  <h4 className="title">UniswapV2</h4>
                </div>
                <div className="right">
              ...
              <Button variant="primary">
                <Flex sx={{alignItems: 'center', justifyContent: 'center'}}>
                  <img sx={{maxWidth: '19px', mr: 2}} src="/images/android.svg" alt="icon"/>
